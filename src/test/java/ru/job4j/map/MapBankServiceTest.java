...
class MapMapBankServiceTest {
    ...
    void whenUserWasFound() {
        ...
        User result = new MapBankService(users).findByPassport("123");
    ...
    void whenUserWasNotFound() {
        ...
        User result = new MapBankService(users).findByPassport("321");
    ...
    void whenAccountWasFound() {
        ...
        Account result = new MapBankService(users).findByRequisite("123", "321123");
    ...
    void whenAccountWasNotFound() {
        ...
        Account result = new MapBankService(users).findByRequisite("123", "123456");
        assertThat(result).isNull();
    }
